        ...
        <div className="container">
          ...
          <form onSubmit={this.handleSubmit} noValidate method="post">
            ...
            <div>
                ...
                <label className="checkbox-inline"><input type="checkbox" value="af" />Arabic</label>&nbsp;
                <label className="checkbox-inline"><input type="checkbox" value="as" />English</label>&nbsp;
                <label className="checkbox-inline"><input type="checkbox" value="am" />Hindi</label>&nbsp;
                <label className="checkbox-inline"><input type="checkbox" value="er" />Urdu</label>&nbsp;
            </div>
